...
from likeable.models import SpideredUrl
...
ap.add_argument('--examples-limit', type=int, default=10, help='How many top candidates per domain should have examples found')
