...
\\set ON_ERROR_STOP 1
\\echo \`date\`
CREATE TABLE jsontmp (blob JSON);
CREATE TABLE articletmp (id BIGINT, url VARCHAR(1000), fb_updated TIMESTAMP, fb_type VARCHAR(35), title TEXT, description TEXT, total_shares BIGINT);
