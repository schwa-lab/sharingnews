...
urlpatterns = patterns('',
    ...
    url(r'^collection/-/(?:/(?P<sig>.+))?$', 'likeable.views.collection', name='collection'),
    url(r'^collection/(?P<start>{m})?-(?P<end>{m})?/(?:/(?P<sig>.+))?$'.format(m=MONTH_PATTERN), 'likeable.views.collection', name='collection-range'),
